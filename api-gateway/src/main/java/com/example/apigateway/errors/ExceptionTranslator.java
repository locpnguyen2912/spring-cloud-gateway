package com.example.apigateway.errors;

import com.example.apigateway.config.Constants;
import com.example.apigateway.exception.UsernameAlreadyUsedException;
import com.example.apigateway.util.HeaderUtil;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "api-gateway");
    }
}
